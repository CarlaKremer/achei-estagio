            ...
            <form class="col s12" action="dadosPessoais" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s3">
                        <input id="idAluno" type="text" class="validate" value="<%if(id != ""){%><%=id%><%}%>" name="txtId" required>
                        <label class="black-text" for="idAluno">ID</label>
                    </div>
                    <div class="input-field col s3">
                        <input id="txtCpf" maxlength="11" type="text" value="<%if(cpf != "" && cpf !=  "null"){%><%=cpf%><%}%>" class="validate" name="txtCpf" required>
                        <label class="black-text" for="cpfAluno">CPF (sem pontuação)</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
                        <input id="nomeAluno" type="text" value="<%if(nome != ""){%><%=nome%><%}%>" name="txtNome" class="validate" required>
