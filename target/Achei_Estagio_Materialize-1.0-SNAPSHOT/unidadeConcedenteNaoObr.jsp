    ...
    <div class="container">
        ...
        <div class="row col s12">
            ...
            <div class="row">
                ...
                <div class="row  col s4">
                    <input value="<%if(cpf != "" &&  cpf != "null"){%><%=cpf%><%System.out.println(cpf);}%>" id="cpfRepresentante" type="text" class="validate" name="txtCpfRepresentante" required>
            ...
            <div class="row">
                ...
                <div class="row col s4">
                    <input value="<%if(email != ""){%><%=email%><%}%>" id="emailSupervisor" type="email" class="validate" name="txtEmailSupervisor" required>
